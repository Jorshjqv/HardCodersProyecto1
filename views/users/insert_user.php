...
<html>
     ...
     <body>
                    ...
                    <div class="form-body">
                        <div class="column-left">
                          <div class="group">
                            ...
                            <input type="number" id="numIdentificationUser" class="general"  placeholder="Identificador único" required>
                          </div>
                          <div class="group">
                            <label for="txtNameUser">Nombre</label>
                            <input type="text" id="txtNameUser" class="general"  placeholder="Nombre" required>
                          </div>
                          <div class="group">
                            <label for="txtSecondNameUser">Apellido</label>
                            <input type="text" id="txtSecondNameUser" class="general"  placeholder="Apellido" required>
                          </div>
                          <div class="group">
                          ...
                          <div class="group">
                            ...
                            <input type=number id="numTelUser" class="general"  placeholder="Número de teléfono" required>
                          </div>
                          ...
                          <div id="studentFormUserLeft">
                           <div class="group">
                              ...
                              <input type="number" id="numHeightUser"  placeholder="Altura del estudiante" class="student">
                            </div>
                            <div class="group">
                            ...
                            <div class="group">
                              ...
                              <input type="text" id="categoryAge" data-age="" class="student"  placeholder="Categoría a la que pertence">          
                            </div>
                            <div class="group">
                              <label for="categoryWeight">Categoría por peso</label>
                              <input type="text" id="categoryWeight" class="student" placeholder="Categoría a la que pertence">          
                            </div>
                          </div>
                        </div>
                        <div class="column-right">
                          <div class="group">
                           ...
                           <div class="group">
                             ...
                             <input type="email" id="txtEmailUser" class="visibility general" name="email"  placeholder="ejemplo@gmail.com" required>
                          </div>
                           <div class="group">
                         ...
                         <div class="group" id="teacherSelect">
                          ...
                          <div class="group">
                              ...
                              <input type="number" id="WeightUser" class="student"  placeholder="Peso del estudiante">
                          </div>
                         <div class="group">
                             <label for="numExhibitionsUser">Exhibiciones Participadas</label>
                             <input type="number" id="numExhibitionsUser" class="student"  placeholder="Cantidad de exhibiciones">
                           </div>
                           <div class="group">
                             <label for="numTournamentWonUser">Torneos Ganados</label>
                            <input type="number" id="numTournamentWonUser" class="student"  placeholder="Cantidad de victorias">
                           </div>
                           <div class="group">
                             <label for="numTournamentParticipatedUser">Torneos Participados</label>
                            <input type="number" id="numTournamentParticipatedUser" class="student" placeholder="Cantidad de participaciones">
                           </div>
                         </div>
                        </div>
                    </div>
          ...
          <script src="../../js/users/users_interface_logic.js"></script>
  </body>
</html>
