...
<html>
     ...
     <body>
               ...
               <div class="forms" id="form">
                 ...
                 <form id="upload_img" enctype="multipart/form-data" name ="upload_img">
                        ...
                        <div class="column-left">
                          ...
                          <div id="studentFormUserLeft">
                           <div class="group">
                            ...
                            <div class="group radio-horizontal">
                              <label for="categoryLevel">Categoría por cinturón</label>
                              <select id="categoryLevel" class="student lengtSelect">
                               
                             </select>
                             <input type="button" id="UpdateLevel" value="Subir Nivel" class="btn btnImportant btn-levelUp">
                            </div>
                            <div class="group">
                    ...
                    <div class="form-footer">
                        <input type="button" value="Guardar" class="btn btnImportant" id="buttonModifyUser" data-userType= "">
                    </div>
                  </form>
               </div>
          </div>
          ...
          <script src="../../js/users/teacher/students_logic_interface_modify.js"></script>
  </body>
</html>