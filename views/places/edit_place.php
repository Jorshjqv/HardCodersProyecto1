...
<html>
     ...
     <body>
          ...
          <div class="navigation">
             ...
             <div class="content-info">
               <div class="forms" id="form">
                ...
                <input type="text" id="placeName" required></input>
                          </div>
                          <div class="group">
                ...
                <input type="number" id="latitude" min="0" max="11">
                          </div>
                 <div class="group">
              <label for="longitude">Longitud</label>
              <input type="number" id="longitude" min="0" max="11">
                          </div>
               <div class="group">
              ...
              <input type="text" id="person">
                ...
                <input type="time" id="endhour" >
                  ...
                  <input type="button" value="Guardar" class="btn btnImportant" id="addBtn">
                    </div>
                  </form>
               </div>
          </div>
		 <div class="clearfix"></div>
          ...
          <script src="../../js/places/places_edit_interface_logic.js"></script>
